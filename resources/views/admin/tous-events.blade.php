@section("titre",'Tous les Evénements')
                ...
                $count_eve1 =  $count_eve1 . $count_eve;
                  ...
                  <tr id="trs" class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <th scope="row" class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      @if ($t->image == null)
                        <img src="{{asset('presentation/presentation.jpg')}}" alt="Fatima" class="w-auto h-8 mr-3 ii">
                  ...
                  <button  data-modal-target="popup-modal{{  $count_eve }}" data-modal-toggle="popup-modal{{  $count_eve }}" class="font-medium text-red-600 dark:text-red-500 hover:underline" type="button">
                   Supprimer
                    ...
                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        ...
                        <button href="{{ route('admin.editevents_archive',['id'=>$t->id]) }}" data-modal-target="popup-modal{{  $count_eve1 }}" data-modal-toggle="popup-modal{{  $count_eve1 }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Archiver</button>
                      ...
                      <div class="relative p-4 w-full max-w-md max-h-full">
                          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                              ...
                              <div class="p-4 md:p-5 text-center">
                                  ...
                                  <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">@if ($t->etat == 0)
                                    Êtes vous sur de vouloir desactiver cette Evènement?
                                    @else
                                    Êtes vous sur de vouloir activer cette Evènement?

                                  @endif</h3>



                                  <form method="POST" action="{{ route('admin.editevents_archive', $t) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
